...
export const listCommitmentsDueSoon = query<undefined, typeof CommitmentsDueSoonOutput._output, MemoryDatabase>({
  ...
  run(ctx) {
    ...
    const commitments = ctx.db.list<Commitment>("commitments", (item) =>
